...
const TextCard = ({ title, text }: TextCardProps) => {
  return (
    <div
      className="md:max-w-72 min-h-max flex flex-col text-sm font-normal p-8 md:p-10 rounded-3xl border dark:border-stone-800 bg-background-secondary dark:glass shadow-lg transition-shadow duration-300
    ">
      <div>
