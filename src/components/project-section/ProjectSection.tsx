    ...
    <Container>
      <div id="projects" className="w-full">
        <div className="grid w-full grid-cols-1 items-start justify-center gap-4 sm:grid-cols-2 md:grid-cols-3 md:gap-6 lg:grid-cols-4 xl:grid-cols-5">
          <div className="animated-background group flex h-56 w-full flex-col items-center justify-center rounded-3xl bg-gradient-to-tr from-orange-500 via-red-600 to-arbxz-accent p-4 text-center text-white duration-500 md:p-8">
