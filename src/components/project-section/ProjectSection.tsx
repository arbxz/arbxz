    ...
    <Container>
      <div id="projects" className="w-full">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 md:gap-6 items-start justify-center w-full">
          <div className="group flex flex-col justify-center items-center w-full h-56 text-center animated-background bg-gradient-to-r from-purple-600 via-purple-500 to-arbxz-accent duration-500 text-white rounded-3xl p-4 md:p-8">
