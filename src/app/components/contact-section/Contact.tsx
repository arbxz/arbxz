...
const Contact = () => {
  ...
  const textToHighlight = () => {
    const highlightedTextArray = [
      ...
      "with expertise in React, Next.js, TypeScript,",
      "and a range of UI libraries. Proficient in",
      "Cypress for testing, I ensure high-quality,",
      "interactive web applications. With Vercel, I",
      "deploy lightning-fast websites. Git and",
      "versioning systems are second nature, ensuring seamless collaboration.",
    ];
  ...
  return (
    <section
      id="contact-section"
      className=" items-center justify-center h-full w-full px-4 mb-10 lg:mb-24">
      <div className="flex flex-auto gap-4 lg:gap-20 items-center justify-center flex-col lg:flex-row w-4/5 lg:w-4/5 mx-auto">
            ...
            <StyledMessageHeader className="messanger-header flex flex-row gap-4 w-full items-center justify-start py-2 px-4">
              ...
              <div className="text-sm z-10">
                <span className="flex items-center gap-3 font-semibold">
                  Arbaaz Mowlabucus{" "}
                  <span className="inline-block rounded-full w-3 h-3 overflow-hidden bg-lime-400"></span>
                </span>
