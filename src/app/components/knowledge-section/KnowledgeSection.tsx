...
const KnowledgeSection = () => {
  ...
  return (
    <div className="relative bg-background h-full md:h-auto md:max-w-2xl flex flex-col mx-auto items-center md:justify-center  md:rounded-2xl shadow-xl overflow-hidden z-10">
